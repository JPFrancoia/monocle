...
<Steps>
  ...
  <Step title="Review your agent's code">
    ...
    When you submit, monocle formats your comments and queues the review for delivery. The agent receives your feedback, addresses it, and can reply in each comment thread. You see the updated diffs, review again, resolve satisfied threads, and iterate.
