...
<Steps>
  ...
  <Step title="Review your agent's code">
    ...
    When you submit, monocle formats your comments and queues the review for delivery. The agent receives your feedback, addresses it, and can reply in each submitted thread. You see the updated diffs, resolve satisfied threads, add any new comments, and iterate.
