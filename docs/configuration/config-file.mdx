...
monocle invokes `wakatime-cli` and lets it use your existing WakaTime or Wakapi setup. Review activity is reported as `code reviewing` while the TUI is recently active.
