...
| `top` | `g`, `Home` | Jump to top |
| `bottom` | `G`, `End` | Jump to bottom |
| `half_up` | `ctrl+u`, `PageUp` | Scroll up half a page |
| `half_down` | `ctrl+d`, `PageDown` | Scroll down half a page |
...
| `reviewed` | `r`, `Space` | Toggle file reviewed |
