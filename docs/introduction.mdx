...
<CardGroup cols={2}>
  ...
  <Card title="Line-level comments" icon="message-square">
    Tag feedback as issues, questions, suggestions, or notes — at the line or file level. Propose exact code changes with suggestion blocks.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/installation">
    Build monocle locally from this checkout.
  </Card>
