...
When you press `r`, monocle records the file content you reviewed. If that file changes again, monocle automatically clears the reviewed mark so it shows up in the unreviewed filter again.
