...
- `monocle` is a thin TUI client. It auto-spawns or attaches to detached `monocle serve`, which owns the engine, SQLite DB, sessions, feedback queue, and Unix socket.
